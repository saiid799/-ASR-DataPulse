...
import { BotanicalFruitBanner } from './BotanicalFruitBanner'

export function BotanicalHeroBanner() {
  return (
    <section className="w-full pt-4 pb-12 overflow-hidden bg-[#FAF6EF]">
      {/* Top Harvest Fruit Artwork (Matching top of the uploaded screenshot) */}
      <BotanicalFruitBanner />
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center mt-2">
        ...
        >
          ...
          <span>OVER 14,000+ HEALTHIER SMILES</span>
        </motion.div>

        {/* The World's First Probiotic Toothpaste (Serif Heading from image) */}
        <motion.h1
        ...
        >
          ...
          <span className="italic font-normal text-[#C85A32]">probiotic toothpaste.</span>
        </motion.h1>
        ...
        >
          Formulated with live dental probiotics, cold-pressed citrus bioflavonoids, and nano-hydroxyapatite to restore enamel, neutralize harmful acids, and balance your oral microbiome naturally.
        </motion.p>
